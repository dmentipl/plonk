...
class PlotOptions:
    ...
    figure: Any = FigureOptions()
    interpolation: Any = InterpolationOptions()
    render: Any = RenderOptions()
    rotation: Any = RotationOptions()
    units: Any = UnitsOptions()
    vector: Any = VectorOptions()
